<script>
  ...
  const getDisplayedProjectURL = () => `https://ourworld.wuyuan.dev/scratch/play/project/${$projectId}`;
  ...
  <Section accent="#4C97FF">
    ...
    <div class="options">
      ...
      <div class="option">
        ...
        {#if $type === "url"}
          <input type="text" bind:value={$projectUrl} spellcheck="false" placeholder="https://..." on:keypress={submitOnEnter} on:input={handleInput}>
        {/if}
      </div>
